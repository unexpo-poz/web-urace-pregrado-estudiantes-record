<?php
$enProduccion		= true;
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/estudiantes/pre_ni_asignados/';
...
$laBitacora			= $_SERVER[DOCUMENT_ROOT].'/log/pregrado/estudiantes/nuevo_ingreso/carga-datos_'.$lapsoProceso.'_fase_D.log';
